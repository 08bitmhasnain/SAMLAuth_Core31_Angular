...
using Shouldly;
using Xunit;
using SAMLAuthenticationSample.Sessions;

namespace SAMLAuthenticationSample.Tests.Sessions
{
    public class SessionAppService_Tests : SAMLAuthenticationSampleTestBase
    {
