...
{
    public abstract class SAMLAuthenticationSampleWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SAMLAuthenticationSampleWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SAMLAuthenticationSampleWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SAMLAuthenticationSampleDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SAMLAuthenticationSampleDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SAMLAuthenticationSampleDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SAMLAuthenticationSampleDbContext, Task<T>> func)
        {
            T result;
